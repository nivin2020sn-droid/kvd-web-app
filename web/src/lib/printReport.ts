  ...
  <table class="ph-breakdown" style="width:100%;border-collapse:collapse;margin-top:6px;">
    ...
    <tbody>
      ...
      <tr style="background:#F3F0FF;">
        ...
        <td style="padding:8px;text-align:right;font-family:'Courier New',monospace;font-weight:800;color:#7C3AED;font-size:12pt;font-variant-numeric:tabular-nums;">${esc(formatDuration(personHoursReport.totalMs))}</td>
      </tr>
    </tbody>
  </table>
  ` : ''}
